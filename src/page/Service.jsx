...
// --- Step 1: Import your logo images ---
import logo1 from '/logo1.png';
import logo2 from '/logo2.png';
import logo3 from '/logo3.png';
import logo4 from '/logo4.png';
import logo5 from '/logo1.png';
...
const brandLogos = [
    { src: logo1, alt: 'Planday Logo' },
    { src: logo2, alt: 'Umbraco Logo' },
    { src: logo3, alt: 'Pearlfisher Logo' },
    { src: logo4, alt: 'Brightpearl Logo' },
    { src: logo5, alt: 'Planday Logo' } // Assuming the last one is a duplicate as in the original
];
...
const InfluencerServices = () => {
    return (
        <div className="bg-white font-sans">
            ...
            >
                <motion.h1
                    className="font-poppins font-bold text-3xl sm:text-4xl md:text-5xl leading-tight sm:leading-[62.4px] text-[#F11C69] mb-4 sm:mb-6"
                ...
                <motion.p
                    className="font-inter font-normal text-base sm:text-lg md:text-2xl leading-relaxed text-slate-600 max-w-3xl sm:max-w-5xl md:max-w-6xl mx-auto mb-3 sm:mb-4"
                    variants={itemVariants}
                >
                    we specialize in delivering impactful digital marketing solutions — from designing influencer campaigns to managing top talent, along with expert handling of social media and native advertising.
                </motion.p>
                ...
                <motion.p
                    ...
                    variants={itemVariants}
                >
                    We work closely with you to develop a custom strategy that aligns perfectly with your business objectives. Our process covers everything from sourcing the right influencers and defining KPIs to crafting authentic brand stories, overseeing campaign execution, managing contracts, and providing detailed reports with actionable insights.
                </motion.p>

                {/* Center Button */}
                <motion.div variants={itemVariants} className="flex justify-center">
                    <button className="w-full sm:w-auto px-6 py-3 flex items-center justify-center gap-2 bg-[#F11C69] text-white cursor-pointer font-bold text-base sm:text-lg rounded-xl shadow-lg hover:bg-pink-700 hover:scale-105 transition-all duration-300">
                        Book a call
                    </button>
                </motion.div>
            </motion.section>
            ...
            {/* 2. Brands Section */}
            <section className="py-12 bg-white -mt-18">
                <div className="max-w-[1121px] h-[200px] bg-[#F1F1F1] mx-auto rounded-xl flex items-center justify-around px-6">

                    <div className="flex justify-around items-center flex-wrap gap-8 w-full">
            ...
            <section className="bg-white py-12 md:py-20 -mt-10 md:-mt-18">
                <div className="container max-w-6xl mx-auto px-4 sm:px-6">
                    <motion.h2
                        className="font-poppins font-bold text-[48px] leading-[62.4px] tracking-normal text-[#F11C69] text-center mb-10 md:mb-16"
                            ...
                            >
                                <div className="bg-[#F3F9FF] w-full h-full rounded-3xl p-4 flex flex-col sm:flex-row items-start space-y-4 sm:space-y-0 sm:space-x-6">
                                    <div className="flex-shrink-0 flex justify-center items-center">
                                        <svg width="56" height="54" viewBox="0 0 69 66" fill="none" className="w-14 h-14 sm:w-[69px] sm:h-[66px]" xmlns="http://www.w3.org/2000/svg">
                                            <rect width="68.1494" height="66" rx="24" fill="url(#paint0_linear_237_818)" />
                                            <path d="M39.2549 22.6166C37.1432 22.6166 35.2532 23.6433 34.0749 25.2183C32.8965 23.6433 31.0065 22.6166 28.8949 22.6166C25.3132 22.6166 22.4082 25.5333 22.4082 29.1383C22.4082 30.5266 22.6299 31.81 23.0149 33C24.8582 38.8333 30.5399 42.3216 33.3515 43.2783C33.7482 43.4183 34.4015 43.4183 34.7982 43.2783C37.6099 42.3216 43.2915 38.8333 45.1349 33C45.5199 31.81 45.7415 30.5266 45.7415 29.1383C45.7415 25.5333 42.8365 22.6166 39.2549 22.6166Z" fill="white" />
                                            <defs>
                                                <linearGradient id="paint0_linear_237_818" x1="13.9397" y1="2.86509e-07" x2="44.8016" y2="66.7691" gradientUnits="userSpaceOnUse">
