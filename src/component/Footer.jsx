...
const Footer = () => (
    <footer className="bg-[#232d32] text-[#7d8c98] py-12 px-4">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row md:items-start md:justify-between gap-8">
            {/* Left Section */}
            <div className="flex-1">
                <h2 className="text-4xl font-bold text-white mb-6">Logo</h2>
            ...
            <div className="flex flex-col md:items-end md:justify-end flex-1 md:mt-14 mt-8">
                <ul className="flex md:space-x-12 space-x-8 justify-start md:justify-end mb-8 md:mb-0 text-xl font-medium">
                    <li>
                        <a href="#" className="hover:text-white transition">Become an Influencer</a>
                    </li>
                    <li>
        ...
        {/* Divider */}
        <hr className="border-[#37434c] my-8" />

        {/* Bottom Section */}
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row md:items-center md:justify-between gap-6">
            <span className="text-lg font-semibold">all rights reserved</span>
